...
其**优点**是模型具有很好的**可读性**，且**分类速度快**；**缺点**是可能会产生过度匹配的问题(所以一般都会有剪枝过程)。决策树在学习时，利用训练数据，根据损失函数最小化原则建立决策树模型，其学习过程包括3个步骤：特征选择、决策树生成和决策树修剪。

决策树学习的思想来源主要有:

- Quinlan在1986年提出的ID3算法
- Quinlan在1993年提出的C4.5算法
- Breiman等人在1986年提出的CART算法
